...
LOOKBACK_DAYS_TREND = 30; LOOKBACK_DAYS_SETUP = 14; LOOKBACK_DAYS_ENTRY = 5
MIN_CANDLES_TREND = 200; MIN_CANDLES_SETUP = 200; MIN_CANDLES_ENTRY = 200
MIN_VOLUME_24H_USD = 50_000; MIN_VOLUME_TREND_MULT = 1.5
FORWARD_WINDOW = 36
MIN_PRECISION = 0.35; MIN_PRECISION_FLOOR = 0.28
MIN_PROFIT_FACTOR = 1.35; MIN_PROFIT_FACTOR_FLOOR = 1.20
MIN_BACKTEST_TRADES = 99; VOLATILITY_MIN = 0.003
...
def calculate_trade_size(entry_px: float, leverage: int, margin_usd: float = None,
    ...
    if margin_usd is not None:
        ...
        margin_base = max(ALT_TRADE_SIZE_USD, MIN_NOTIONAL_USD / leverage)
...
def main():
    ...
    # Imposta isolated in background (non blocca il boot)
    threading.Thread(target=set_all_isolated, name="SetIsolated", daemon=True).start()
